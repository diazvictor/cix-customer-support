...
var sidenavCollapse = document.querySelector(".sidenav div[data-collapse=reports]");
...
if (window.location.pathname == "/reports/") {
  ...
  var toggleItems = document.querySelectorAll(".toggle-contact");
  toggleContact.addEventListener('change', function (e) {
  ...
  var fileinput = filebutton.querySelector("label input[type=file]");
  var filename = document.querySelector(".file input[type=text]");
  ...
  var toggleDiscussions = document.querySelector(".toggle-discussions");
  var discussions = document.querySelector(".discussions");
  toggleDiscussions.addEventListener("click", function () {
...
},{"../common/ccs.js":5,"../common/navbar.js":7,"../common/sidebar.js":8}]},{},[13]);
